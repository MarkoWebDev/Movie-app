      ...
      {pathname === "/discovery" && (
        <div>
          ...
          <p className="text-[#b9bdcc] font-lato text-base font-medium">
            ...
            filmova ili epizoda vaših omiljenih serija. Uz JustWatch budite
            uvijek u tijeku. Što je novo na Netflixu, HBO Nordicsu ili Viaplayu?
            Uvijek ćete prvi doznati. Koristite filtere i odaberite omiljenu
            streaming platformu, žanr ili godinu izdanja. Naš Watchbar zapamtit
            će vaše postavke.
          </p>
